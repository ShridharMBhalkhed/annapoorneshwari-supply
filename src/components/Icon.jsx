const icons = {
  ...
  messageCircle: (
    <>
      <path d="M21 11.5a8.4 8.4 0 0 1-9 8.4 8.5 8.5 0 0 1-4-.9L3 20l1.1-4.7a8.5 8.5 0 1 1 16.9-3.8Z" />
      <path d="M8.5 9.5c.5 2 2 3.5 4 4l1.4-1.4 2.1.5v2.2c0 .7-.6 1.2-1.3 1.1-4.4-.7-7.9-4.2-8.6-8.6C6 6.6 6.5 6 7.2 6h2.2l.5 2.1-1.4 1.4Z" />
    </>
  ),
  menu: (
    <>
